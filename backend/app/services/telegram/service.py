...
from app.schemas.telegram import TgUpdate
    ...
    async def handle_update(self, update: dict) -> None:
        try:
            ...
            logger.warning(
                ...
                extra={"update_keys": list(update.keys()) if isinstance(update, dict) else None},
            )
            return
        except Exception:
            logger.exception("Unhandled error in telegram handle_update")
            return
